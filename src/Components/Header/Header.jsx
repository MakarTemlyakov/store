...
const Header = ({ setOption }) => {
  ...
  const [selectedDisplayType, setSelectDisplayType] = useState(displayTypeOptions[0]);
      ...
      <div className="container">
        <div className="header-wrapper">
          ...
          <div className="filter__wrapper">
            ...
            <div className="filter" id="filter_menu" onClick={() => setOpenMenu(!isOpen)}>
          ...
          <div className="display-type">
            ...
            <div
              ...
              <ul className={isEditDisplayType ? 'display-list active' : 'display-list'}>
                {displayTypeOptions.map(
                  (displayType) =>
                    displayType.id !== selectedDisplayType.id && (
                      <li key={displayType.id} onClick={() => setSelectDisplayType(displayType)}>
                        {displayType.name}
                      </li>
                    ),
                )}
          ...
          <Button onClick={() => setIsOpenModal(true)}>Вход</Button>
        </div>
